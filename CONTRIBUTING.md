...
- Do not commit secrets, dumps, backups, or uploaded files.
...
If you find a security issue, please do not open a public issue immediately.  
Use the private reporting instructions in `SECURITY.md`.

...
_PAGES = {
    ...
    "guide": {
        ...
        "description": (
            "Полное руководство по бесплатной Nika CRM: заявки, клиенты, склад, магазин, "
            "касса, зарплата, отчёты, портал клиента и чат сотрудников."
        ),
        "keywords": (
            "руководство Nika CRM, заявки ремонт, склад запчастей, касса СЦ, "
            "зарплата мастеров, портал клиента, бесплатная CRM"
        ),

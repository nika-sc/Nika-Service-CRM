...
Документация находится в папке `save/docs/`:
- [Руководство пользователя](save/docs/USER_GUIDE.md) - полное руководство по использованию системы
- [Архитектура](save/docs/ARCHITECTURE.md) - описание архитектуры системы
- [API документация](save/docs/API.md) - описание API endpoints
- [Примеры использования сервисов](save/docs/SERVICES_EXAMPLES.md) - примеры кода
- [Улучшения безопасности](save/docs/SECURITY_IMPROVEMENTS.md) - описание реализованных мер безопасности
- [Нормализация справочников](save/docs/NORMALIZATION_IMPLEMENTATION.md) - описание нормализации данных (Миграция 013)
- [Рекомендации по улучшению БД](save/docs/DATABASE_IMPROVEMENTS.md) - рекомендации по улучшению структуры базы данных
- [Предложения по улучшению](save/docs/IMPROVEMENTS_PROPOSAL.md) - план развития системы
- [TODO и улучшения](save/docs/TODO_AND_IMPROVEMENTS.html) - список задач и выполненных функций
- [Go/No-Go checklist](save/docs/GO_NO_GO_CHECKLIST.md) - чеклист готовности к релизу
- [Rollout runbook](save/docs/ROLLOUT_RUNBOOK.md) - поэтапный выпуск, откат и пост-релизный контроль
- [План скриптов и исправлений](save/docs/PLAN_SCRIPTS_AND_FIXES.md) - запуск скриптов проверки (касса, отчёты, импорт), создание проводок для оплат без записи в кассе

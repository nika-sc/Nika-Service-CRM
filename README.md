...
- **Счета (B2B)**: реестр для ИП/юрлиц, печать счёта/акта/накладной (TinyMCE-шаблоны, A4), оплата с заявкой или через магазин.
...
- Блог: [08-invoices-b2b](docs/blog/08-invoices-b2b.md), [09-invoices-print-ux](docs/blog/09-invoices-print-ux.md).

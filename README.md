...
- **Касса и зарплата**: движение денег, начисления при закрытии, выплаты; смена мастера/менеджера на закрытой заявке с переносом начислений.

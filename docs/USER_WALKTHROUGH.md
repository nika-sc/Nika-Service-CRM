...
- в шаблоне письма присутствует тег `##PORTAL_URL##` (в шаблоне по умолчанию он уже есть; свой шаблон правится в **Настройки → Шаблоны писем → Заказ принят**).
...
3. Кнопка **«Показать пароль»** покажет выданный пароль (доступна, пока клиент его не сменил), либо задайте свой и сохраните.

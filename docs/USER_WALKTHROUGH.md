...
13. [Чек-лист конца дня](#13-чек-лист-конца-дня)
...
4. Документ открывается на формате A4 с полями из общих настроек печати.
...
Подробнее: [USER_GUIDE §10](USER_GUIDE.md#10-счета-юрлица-и-ип), блог [печать и шаблоны](/blog/invoices-print-ux).

---

## 13. Чек-лист конца дня

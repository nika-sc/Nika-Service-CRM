...
- Обновили безопасность и ускорили основные разделы; в диагностике — готовые шаблоны текста. [Блог](/blog/security-catalog-invoices), [гайд](USER_GUIDE.md).

## Что нового в версии 1.10 (2026-08-20)

- Диагностика: готовые **шаблоны текста** по типу/марке/модели, текст мастера не затирается. [Блог](/blog/diagnostics-templates-perf), [USER_GUIDE § 5.4.2](USER_GUIDE.md#542-диагностика-заявки).
...
**Диагностика.** Перед «Готова», «Закрыта» и любым статусом с запретом правки или финальным сохраните **текст** диагностики (фото JPEG/PNG/PDF по желанию, до 10 файлов). В окне можно выбрать шаблон — пустое поле заполнится, уже написанное дополнится. Если текста нет, откроется окно — статус применится после «Сохранить текст». Правка уже сохранённого текста и удаление фото — у администратора; на закрытой заявке диагностику меняет только администратор. Клиент видит текст и фото в кабинете.

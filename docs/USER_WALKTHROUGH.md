...
- Обновили безопасность и ускорили основные разделы; в диагностике — готовые шаблоны текста. Во вкладке **История** заявки — какие письма ушли клиенту. [Блог](/blog/security-catalog-invoices), [письма](/blog/order-customer-emails), [гайд](USER_GUIDE.md).

## Что нового в версии 1.10 (2026-08-20)

- Диагностика: готовые **шаблоны текста** по типу/марке/модели (Настройки → Шаблоны диагностики); другой шаблон заменяет предыдущий. [Блог](/blog/diagnostics-templates-perf), [USER_GUIDE § 5.4.2](USER_GUIDE.md#542-диагностика-заявки).

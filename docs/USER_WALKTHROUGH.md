...
- Канбан заявок — доска очереди цеха: этапы горизонтально, сверху кто ждёт дольше, цвет карточки по возрасту. [Блог](/blog/workshop-kanban), [USER_GUIDE § 5.2](USER_GUIDE.md).

## Что нового в версии 1.15 (2026-09-17)

- Полный возврат оплаты снимает исходный приход из кассы и сводного отчёта: ошибочная сумма больше не остаётся в «Приходе». [Блог](/blog/refund-voids-cash), [USER_GUIDE § 5.7](USER_GUIDE.md).

## Что нового в версии 1.14 (Windows SETUP 1.0.9, 2026-09-14)

- Windows SETUP **1.0.9**: на карточке заявки снова добавляются услуги, товары и оплаты (раньше могло показать «Страница не найдена»). [Блог 1.0.9](/blog/windows-setup-1-0-9), [USER_GUIDE § 2.3](USER_GUIDE.md).

...
**Важно:** Все JSON/HTML API endpoints защищены `@login_required` (включая модуль чата сотрудников `/api/staff-chat/*`). Доступ без авторизации блокируется (302, 401, 403).

...
- режимы **реестр** и **канбан** (хронология приёма — отчёт [Журнал заявок](/docs/guide#12-отчёты), не вкладка списка);
- **реестр** — поиск, колонки, быстрая смена статуса, закрепление, суммы;
- **канбан** — очередь цеха по этапам: горизонтальная доска, сверху кто ждёт дольше, пустые этапы видны. Цвет карточки по возрасту: зелёный до 3 дней, жёлтый 4–6, оранжевый 7–13, красный от 14. Клик открывает заявку; статус меняют там же, не перетаскиванием;
...
**Возврат оплаты** (только администратор):

1. У оплаты нажмите **Возврат**.
2. Сумма ≤ остатка оплаты, причина обязательна.
3. Полный возврат **снимает исходный приход** в кассе и в сводном отчёте (ошибочная сумма больше не висит в «Приходе»). Частичный возврат пишет расход на возвращённую сумму.
...
**Касса не сходится с отчётом.** Ищите ручные правки и операции без документов. Если оплату по заявке уже вернули, а приход всё ещё держит ту же сумму — обновите CRM: полный возврат теперь снимает исходную проводку.
...
| **3.18** | **2026-09-17** | Полный возврат оплаты снимает исходный приход из кассы и сводного отчёта (§ 5.7); блог 46 |

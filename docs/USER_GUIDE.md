...
Офлайн-установщик для Windows 10/11 x64 (встроенные Python 3.12, PostgreSQL 18, демо-база), версия **1.0.7**, дата сборки **2026-09-10**:

1. Скачайте [NikaCRM-Offline-Setup-1.0.7-x64.exe](https://github.com/nika-sc/Nika-Service-CRM/releases/download/windows-setup-1.0.7/NikaCRM-Offline-Setup-1.0.7-x64.exe)  
   или зеркало на [service.nika-crm.ru/downloads/…](https://service.nika-crm.ru/downloads/NikaCRM-Offline-Setup-1.0.7-x64.exe).
...
**Что нового в 1.0.7:** категории склада правятся и удаляются с панели товаров (§ 7.2), заработало удаление номенклатуры и закупки, колонка «Действия» в списке товаров закреплена у правого края, в кассе видна сверка по внешним приходам, возврат чека доступен только администратору. Служебные пароли базы больше не попадают в журнал установки, а `%ProgramData%\NikaCRM` доступен только администраторам компьютера. См. блог [windows-setup-1-0-7](/blog/windows-setup-1-0-7).
